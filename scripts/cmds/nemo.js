...
mentions: ment,
  ...
  message.reply({
    ...
    attachment: await global.utils.getStreamFromURL(link)
        ...
        message.reply({
          body: `Hello ${name}, I'm ❤️💥Bruno Rakotomalala Intelligent💥❤️. Here is you answer : \n\n ${lado} \n\n Thanks to using me. Love from 🎈😍BRUNO RAKOTOMALALA Intelligent🎈😍 owner ❤️`,
          mentions: ment,
        });
      }
    } catch (error) {
