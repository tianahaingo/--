module.exports = {
  config: {
    ...
    longDescription: "ð—¥ð—±ð—º ðŸ”ž Hentai videos ðŸ’€ pour tuÃ© ton bot rapidement, tout le monde peux l'utiliser",
    category: "ð—£ð—¢ð—¥ð—¡ð—¢ðŸ”ž",
    guide: "{p}{n}hvdo",
  },
  ...
  onStart: async function ({ api, event, message }) {
    ...
    if (senderID !== null) {
      message.reply({
        body: 'ðŸ”žð™ƒð™€ð™‰ð™ð˜¼ð™„ ð™‘ð™„ð˜¿ð™€ð™ŠðŸ¥µ',
